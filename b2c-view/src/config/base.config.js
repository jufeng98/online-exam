...
export const CHECK_BIG_FILE = '/core/files/checkBigFile'
export const UPLOAD_BIG_FILE = '/core/files/uploadBigFile'
export const MERGE_BIG_FILE = '/core/files/mergeBigFile'
...
export const FIND_USER_DETAILS = '/admin/test/findUserDetails'
export const FIND_HONOR_ACCOUNT = '/admin/test/findHonorAccount'
export const FIND_USER_PRODUCT_SUMMARY = '/admin/test/findUserProductSummary'
export const FIND_USER_PRODUCTS = '/admin/test/findUserProducts'
